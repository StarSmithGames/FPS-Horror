...
namespace cowsins
{
    public class WeaponAnimator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (weaponBehaviour.Reloading || player.IsCrouching || !player.Grounded || rb.velocity.magnitude < 0.1f || weaponBehaviour.IsAiming
            ...
            if (rb.velocity.magnitude > player.CrouchSpeed && player.CurrentSpeed < player.RunSpeed && player.Grounded && !interactManager.Inspecting) CowsinsUtilities.PlayAnim("walking", currentAnimator);
